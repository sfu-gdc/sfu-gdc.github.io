...
spritesheet.src = "res/img/main-page-game/spritesheet-outline.png";
...
spritesheetKeys.src = "res/img/main-page-game/spritesheet-keys.png";
    ...
    for (let i = 0; i < colliders.length; i++) {
        ...
        if (AABBIntersect(translatedPlayerRect, col)) {
            if (yPos < col.top) {
                ...
                let xIntersectWithTop = (col.top - yPos) * (xMove / yMove);
                ...
                let xIntersectWithBot = (col.bottom - yPos) * (xMove / yMove);
